...
class EscrowTransferOperation(Base):
    ...
    __table_args__ = (
        ...
        Index('ix_sbds_op_escrow_transfers_accounts', 'accounts', postgresql_using='gin')
    ...
    operation_type = Column(operation_types_enum, nullable=False, default='escrow_transfer')
    ...
    _fields = dict(
        ...
        ratification_deadline=lambda x: dateutil.parser.parse(
            x.get('ratification_deadline')),  # steem_type:time_point_sec
