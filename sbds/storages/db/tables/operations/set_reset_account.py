...
class SetResetAccountOperation(Base):
    ...
    __table_args__ = (ForeignKeyConstraint(
        ...
        use_alter=True),
        Index(
        'ix_sbds_sbds_op_set_reset_accounts_unique',
        'block_num',
        'transaction_num',
        'operation_num',
        unique=True),
        Index(
        'ix_sbds_op_set_reset_accounts_accounts',
        'accounts',
    ...
    _fields = dict(accounts=lambda x: accounts_field(x, 'set_reset_account'), )
