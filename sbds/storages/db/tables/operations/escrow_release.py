...
class EscrowReleaseOperation(Base):
    ...
    __table_args__ = (ForeignKeyConstraint(
        ...
        use_alter=True),
        ForeignKeyConstraint(
        ['receiver'], ['sbds_meta_accounts.name'],
        deferrable=True,
        initially='DEFERRED',
        use_alter=True),
        Index(
        'ix_sbds_sbds_op_escrow_releases_unique',
        'block_num',
        'transaction_num',
        'operation_num',
        unique=True),
        Index(
        'ix_sbds_op_escrow_releases_accounts',
        'accounts',
    ...
    receiver = Column(Text, nullable=True)  # steem_type:account_name_type
    ...
    _fields = dict(
        ...
        accounts=lambda x: accounts_field(x, 'escrow_release'),
    )
