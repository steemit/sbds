...
class AuthorRewardVirtualOperation(Base):
    ...
    __table_args__ = (
        ...
        Index('ix_sbds_op_virtual_author_rewards_accounts', 'accounts', postgresql_using='gin')
    ...
    operation_type = Column(operation_types_enum, nullable=False, default='author_reward')
