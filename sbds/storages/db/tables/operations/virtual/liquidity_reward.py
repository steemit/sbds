...
class LiquidityRewardVirtualOperation(Base):
    ...
    __table_args__ = (
        ...
        Index('ix_sbds_op_virtual_liquidity_rewards_accounts', 'accounts', postgresql_using='gin')
    ...
    operation_type = Column(operation_types_enum, nullable=False, default='liquidity_reward')
