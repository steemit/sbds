...
class DelegateVestingSharesOperation(Base, BaseOperation):
    ...
    delegator = Column(String(16), ForeignKey("sbds_meta_accounts.name")) # steem_type:account_name_type
    delegatee = Column(String(16), ForeignKey("sbds_meta_accounts.name")) # steem_type:account_name_type
    ...
    operation_type = Column(
        ...
        nullable=False,
        index=True,
        default='delegate_vesting_shares')
