...
class DelegateVestingSharesOperation(Base):
    ...
    __table_args__ = (
        ...
        Index('ix_sbds_op_delegate_vesting_share_accounts', 'accounts', postgresql_using='gin')
    ...
    operation_type = Column(operation_types_enum, nullable=False, default='delegate_vesting_shares')
