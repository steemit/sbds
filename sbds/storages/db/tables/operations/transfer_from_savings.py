...
class TransferFromSavingsOperation(Base):
    ...
    __table_args__ = (
        ...
        Index('ix_sbds_op_transfer_from_saving_accounts', 'accounts', postgresql_using='gin')
    ...
    operation_type = Column(operation_types_enum, nullable=False, default='transfer_from_savings')
