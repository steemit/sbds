...
class LimitOrderCreateOperation(Base):
    ...
    __table_args__ = (ForeignKeyConstraint(
        ...
        use_alter=True),
        Index(
        'ix_sbds_sbds_op_limit_order_creates_unique',
        'block_num',
        'transaction_num',
        'operation_num',
        unique=True),
        Index(
        'ix_sbds_op_limit_order_creates_accounts',
        'accounts',
    ...
    _fields = dict(
        ...
        accounts=lambda x: accounts_field(x, 'limit_order_create'),
    )
