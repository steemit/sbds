...
class TxBase(object):
    ...
    def __table_args__(cls):
        args =(
            Index('ix_unique_%s' % cls.__tablename__, 'tx_id','transaction_num', 'operation_num', unique=True),
            {
                'mysql_engine': 'InnoDB',
...
class TxAccountCreate(Base, TxBase):
    ...
    __tablename__ = 'TxAccountCreates'
...
class TxAccountRecover(Base, TxBase):
    ...
    __tablename__ = 'TxAccountRecovers'
...
class TxAccountUpdate(Base, TxBase):
    ...
    __tablename__ = 'TxAccountUpdates'
...
class TxAccountWitnessProxy(Base, TxBase):
    ...
    __tablename__ = 'TxAccountWitnessProxies'
...
class TxAccountWitnessVote(Base, TxBase):
    ...
    __tablename__ = 'TxAccountWitnessVotes'
...
class TxCommentsOption(Base, TxBase):
    ...
    __tablename__ = 'TxCommentsOptions'
...
class TxCurationReward(Base, TxBase):
    ...
    __tablename__ = 'TxCurationRewards'
...
class TxDeleteComment(Base, TxBase):
    ...
    __tablename__ = 'TxDeleteComments'
...
class TxWithdrawVestingRoute(Base, TxBase):
    ...
    __tablename__ = 'TxWithdrawVestingRoutes'
...
class TxWitnessUpdate(Base, TxBase):
    ...
    __tablename__ = 'TxWitnessUpdates'
