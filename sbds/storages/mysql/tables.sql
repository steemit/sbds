...
CREATE TABLE IF NOT EXISTS Blocks (
	raw JSON NOT NULL,
	block_num INT UNSIGNED GENERATED ALWAYS AS (CONV(LEFT(raw->>"$.previous", 8), 16, 10) + 1) STORED PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS Transactions (
	tx_id integer UNSIGNED NOT NULL auto_increment,
	block_num integer UNSIGNED NOT NULL,
	transaction_num tinyint UNSIGNED NOT NULL,
	ref_block_num integer UNSIGNED NOT NULL,
	ref_block_prefix bigint UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS Transactions2 (
	...
	type enum('vote',
						...
						'set_reset_account_operation') NOT NULL,
	PRIMARY KEY (block_num, transaction_num)
) ENGINE InnoDB DEFAULT CHARACTER SET utf8 DEFAULT COLLATE utf8_general_ci;
